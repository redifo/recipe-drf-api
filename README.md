...
- [Recipe Domain](#recipe-domain)
  ...
  * [Features](#features)
    + [User-Friendly Home Page](#user-friendly-home-page)
    + [Recipe Creation and Management](#recipe-creation-and-management)
    + [Recipe Search and Filtering](#recipe-search-and-filtering)
    + [Dynamic Recipe Rating and Reviews](#dynamic-recipe-rating-and-reviews)
    + [Social Interaction and Engagement](#social-interaction-and-engagement)
    + [Mobile Responsive Design](#mobile-responsive-design)
    + [Security Features](#security-features)
    + [Recipe Tag Filtering](#recipe-tag-filtering)
    + [Personalized User Profiles with Enhanced Customization](#personalized-user-profiles-with-enhanced-customization)
    + [Favorite Recipes Feature](#favorite-recipes-feature)
  * [Re-use of Components](#re-use-of-components)
    ...
    + [**FooterPage.js**](#--footerpagejs--)
    + [**ProfileDataContext**](#--profiledatacontext--)
  ...
  * [Technologies Used](#technologies-used)
    ...
    + [Backend](#backend)
    + [Database](#database)
    + [Utilities & Additional Tools](#utilities---additional-tools)
    + [Libraries & Packages](#libraries---packages)
    + [Other Programs Used](#other-programs-used)
  * [Testing](#testing)
  * [Deployment](#deployment)
    + [Step 1: Fork or Clone the Repository](#step-1--fork-or-clone-the-repository)
    + [Step 2: Set Up Cloudinary](#step-2--set-up-cloudinary)
    + [Step 3: Deploy to Heroku](#step-3--deploy-to-heroku)
    + [Step 4: Configure Environment Variables in Heroku](#step-4--configure-environment-variables-in-heroku)
    + [Step 5: Deploy Backend and Frontend](#step-5--deploy-backend-and-frontend)
  * [Credits](#credits)
    + [Code](#code)
...
- Utilized solutions from Stack Overflow to handle autoplay issues in React SwiperJS:
  [React SwiperJS Autoplay Issue](https://stackoverflow.com/questions/63052586/react-swiperjs-autoplay-not-making-the-swiper-to-auto-swipe)
  
- Implemented drag-and-drop file uploads in the project using guidance from:
  [React Dropzone Documentation](https://react-dropzone.js.org/)

- Adopted techniques for Django signals to notify users about comments from:
  [Django Signals for Comment Notification](https://stackoverflow.com/questions/64069110/django-signals-for-comment-notification)

- Followed strategies for inclusion and exclusion filtering with Django REST Framework and Django Filter from:
  [Inclusion and Exclusion Filtering with Django REST Framework and Django Filter](https://michaelprather.medium.com/inclusion-and-exclusion-filtering-with-django-rest-framework-and-django-filter-e90a597f2af5)

- Styled the footer using components and examples from:
  [MDBootstrap Footer Documentation](https://mdbootstrap.com/docs/standard/navigation/footer/)


- Extensively referenced throughout the project for understanding React concepts and components:
  [React Documentation](https://react.dev/reference/react)
  
- Consulted for routing and navigation implementations in React applications:
  [React Router Documentation](https://v5.reactrouter.com/)

- Utilized for understanding generic views in Django REST Framework:
  [Django REST Framework Generic Views](https://www.django-rest-framework.org/api-guide/generic-views/)

- Referred to for filtering techniques in Django applications:
  [Django Filter Documentation](https://django-filter.readthedocs.io/en/stable/guide/usage.html)

### Project Files

- `utils.js`, `useClickOutsideToggle.js`, `useRedirect.js`, profile, username, and password edit pages, `CurrentUserContext.js`, `ProfileDataContext.js`, `asset.js`, `MoreDropDown.js`, `NotFound.js`, `Avatar.js` files were largely sourced and minimally adjusted from the Code Institute's Moments walkthrough project. Other files were also inspired by the walkthrough but underwent significant edits.
