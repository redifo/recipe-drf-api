...
- [Frontend Testing](#frontend-testing)
  ...
  * [Resolved bugs](#resolved-bugs)
    + [Authentication Checks in Recipe Serializer](#authentication-checks-in-recipe-serializer)
    + [Editing Review Functionality](#editing-review-functionality)
    + [Image Uploads to Cloudinary](#image-uploads-to-cloudinary)
    + [Likes and Dislikes Count Adjustments](#likes-and-dislikes-count-adjustments)
    + [Layout Adjustments on Large Screens](#layout-adjustments-on-large-screens)
    + [Non-Responsive Signup Link in Mobile View](#non-responsive-signup-link-in-mobile-view)
  * [Unresolved Bugs](#unresolved-bugs)
    + [Remove Image Button in Recipe Create/Edit Form](#remove-image-button-in-recipe-create-edit-form)
    + [Multiple Review Postings on Rapid Clicks](#multiple-review-postings-on-rapid-clicks)
